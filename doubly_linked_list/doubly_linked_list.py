...
class ListNode:
    ...
    def insert_after(self, value):
        current_next = self.next #if current_next is none, self.next is none. #if want to insert 2 between 1h >3, curr_next=3 
        self.next = ListNode(value, self, current_next)  #here just makes new instance of ListNode, declare self.next as value #
        if current_next: #if no current_next dont need to run line 
            current_next.prev = self.next # whats Cur_next.prev for aftervvalue you want to insert = self.next
    ...
    def insert_before(self, value):
        ...
        if current_prev:
            current_prev.next = self.prev # whats Cur_prev.next for prevvalue you want to insert = self.prev
