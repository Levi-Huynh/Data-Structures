...
class LRUCache:
    ...
    def set(self, key, value):
        ...
        if self.size > self.limit:
            ...
            # why value here is [0]??
            # del=python keyword delete object
            del self.storage[self.order.head.value[0]]  # DELETE LRU,
            #mynode = self.order.head.value
            # self.order.delete(mynode)
            # REMOVE POINTERS FROM ORDER
